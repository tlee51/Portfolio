...
export default function Intro() {
  ...
  return (
    <section ref={ref} id="home" className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
        ...
        >
            <span className='font-bold'>Hello, I am Thomas</span>
            {/* . I'm a{" "}
        ...
        >
            ...
            hover:scale-110 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10' href="/CV.pdf" download>
            ...
            borderBlack dark:bg-white/10 dark:text-white/60' href="https://github.com/tlee51" target="_blank">
                <FaGithubSquare />
            </a>
        </motion.div>
    </section>
