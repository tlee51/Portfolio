...
export default function Contact() {
  ...
  return (
    ...
    >
        ...
        <p className='text-gray-700 -mt-6 dark:text-white/80'>Please contact me directly at <a className='underline' href="mailto:thomaslee0519@gmail.com">thomaslee0519@gmail.com</a> or through this form.</p>
