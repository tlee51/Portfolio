...
export default function Header() {
  ...
  return (
    <header className='z-[999] relative'>
        ...
        sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full dark:bg-gray-950 dark:border-black/40 
        dark:bg-opacity-75'
        ...
        <nav className='flex fixed top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] 
